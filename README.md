...
<table border="0" cellspacing="0" cellpadding="0" style="border: none; border-collapse: collapse;">
  <tr style="border: none;">
    <td style="border: none; padding: 6px 10px 6px 0;">
  ...
  <tr style="border: none;">
    ...
    <td style="border: none; padding: 6px 10px 6px 0;">
      <a href="https://www.langchain.com/langgraph" target="_blank" rel="noreferrer">
        <img src="https://cdn.jsdelivr.net/npm/simple-icons/icons/langgraph.svg" alt="langgraph" width="40" height="40" />
      </a>
    </td>
    <td style="border: none; padding: 6px 10px 6px 0;">
    ...
    <td style="border: none; padding: 6px 0;">
      <a href="https://modelcontextprotocol.io/" target="_blank" rel="noreferrer">
        <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Model_Context_Protocol_logo.svg" alt="mcp" width="40" height="40" />
      </a>
    </td>
  </tr>
</table>
